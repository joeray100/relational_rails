...
describe "Show Employees table" do
  ...
  describe "Employee Index" do
    it "Shows Only records where the Boolean Column is true" do
      business1 = create(:business)
      employee1 = create(:employee, business_id: business1.id, likes_job: true )
      employee2 = create(:employee, business_id: business1.id, likes_job: false)
      ...
      expect(page).to_not have_content(employee2.likes_job)
      expect(page).to_not have_content(employee2.hours_worked)
  end
end
